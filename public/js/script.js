...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.innerWidth > 768) {
        // Text wave animation only makes sense on the desktop nav layout
        textWaveAnimation();
    }
...
// The navigation markup is now rendered server-side in src/includes/header.php
// (for crawlability / SEO). This just wires up the interactive behavior.
