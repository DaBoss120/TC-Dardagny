    ...
    <main style="opacity: 0;">
        <div class="carousel">
            <div class="carouselSlides">
                ...
                <img src="/img/CarouselIMG1.webp" alt="CarouselIMG1" style="width:100%">
                <!-- <div class="slideText">
                    <h2>Venez Jouer !</h2>
                    <p>Sport<b>,</b> santé<b>, et</b> bien être <b>sont nos</b> priorités !</p>
                </div> -->
            </div>

            <div class="carouselSlides">

                <img src="/img/CarouselIMG2.webp" alt="CarouselIMG2" style="width:100%">
                <!-- <div class="slideText">
                    <h2>Cours Juniors</h2>
                    <h2>Hiver 2023-2024</h2>
                    <h3>Inscriptions ouvertes</h3>
                </div> -->
            </div>
            <div class="carouselSlides">
                <img src="/img/TennisCourtNet.webp" alt="CarouselIMG3" style="width:100%">
                <!-- <div class="slideText">
                    <h2>TC Dardagny 2 courts a disposition</h2>
                    <p>Réservez dès maintenant votre court</p>
                </div> -->
            </div>
